...
class TestApiGateway(TestCase):
    ...
    def setUp(self) -> None:
        ...
        here we use cloudformation API to find out what the LogUsersApi URL is
        """
        ...
        api_outputs = [output for output in stack_outputs if output["OutputKey"] == "LogUsersApi"]
        self.assertTrue(api_outputs, f"Cannot find output LogUsersApi in stack {stack_name}")
